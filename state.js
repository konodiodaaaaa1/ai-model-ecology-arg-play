...
export const STORY_MILESTONES = Object.freeze([
  ...
  { id: "relay-console-created", time: "03:22", event: "relay-console-created" },
...
export function getUnlocks(state) {
  return {
    ...
    channel: hasMilestone(state, "relay-console-created"),
...
function normalize(candidate) {
  ...
  next.relayMonitorDetailOpen = Boolean(next.relayMonitorDetailOpen);
